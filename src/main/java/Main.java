...
public class Main {
    ...
    //                Row row12 = sheet.getRow(42);
    //                int j =15;
    //                int k= 0;
    //                while (j>=0){
    //                    cells3.add(k,row12.getCell(j));
    //                    cells3.get(k).setCellValue(arrayList.get(k).getExpenses());
    //                    j=j-3;
    //                    k++;
    //                }
    //
    ...
    //                        rows.add(sheet.getRow(24+i));
    //                        Cell cell12 = rows.get(i).getCell(18);
